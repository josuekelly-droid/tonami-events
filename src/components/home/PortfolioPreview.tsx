...
export default function PortfolioPreview() {
  ...
  useEffect(() => {
    fetch("/api/public/projets")
      .then((res) => res.json())
      .then((data) => {
        // Afficher seulement les projets mis en avant, ou les 3 derniers
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {projets.map((projet, index) => (
            <motion.div
              ...
              className="group relative bg-gray-light/20 rounded-2xl overflow-hidden aspect-[4/3] cursor-pointer"
            >
              <img
                src={projet.image}
                alt={projet.titre}
              ...
              />
              <div className="absolute inset-0 bg-tertiary/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                <div>
